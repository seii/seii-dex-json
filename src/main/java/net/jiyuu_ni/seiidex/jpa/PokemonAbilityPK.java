...
/**
 * The primary key class for the pokemon_abilities database table.
 * 
 */
@Embeddable
public class PokemonAbilityPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PokemonAbilityPK)) {
			return false;
		}
		PokemonAbilityPK castOther = (PokemonAbilityPK)other;
		return 

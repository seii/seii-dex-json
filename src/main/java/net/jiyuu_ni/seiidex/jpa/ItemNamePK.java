...
/**
 * The primary key class for the item_names database table.
 * 
 */
@Embeddable
public class ItemNamePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ItemNamePK)) {
			return false;
		}
		ItemNamePK castOther = (ItemNamePK)other;
		return 

...
/**
 * The primary key class for the ability_names database table.
 * 
 */
@Embeddable
public class AbilityNamePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof AbilityNamePK)) {
			return false;
		}
		AbilityNamePK castOther = (AbilityNamePK)other;
		return 

...
/**
 * The primary key class for the item_flavor_summaries database table.
 * 
 */
@Embeddable
public class ItemFlavorSummaryPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ItemFlavorSummaryPK)) {
			return false;
		}
		ItemFlavorSummaryPK castOther = (ItemFlavorSummaryPK)other;
		return 

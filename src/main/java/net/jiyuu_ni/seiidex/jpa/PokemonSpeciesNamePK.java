...
/**
 * The primary key class for the pokemon_species_names database table.
 * 
 */
@Embeddable
public class PokemonSpeciesNamePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PokemonSpeciesNamePK)) {
			return false;
		}
		PokemonSpeciesNamePK castOther = (PokemonSpeciesNamePK)other;
		return 

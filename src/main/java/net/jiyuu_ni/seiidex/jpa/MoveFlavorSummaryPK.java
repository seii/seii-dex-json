...
/**
 * The primary key class for the move_flavor_summaries database table.
 * 
 */
@Embeddable
public class MoveFlavorSummaryPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MoveFlavorSummaryPK)) {
			return false;
		}
		MoveFlavorSummaryPK castOther = (MoveFlavorSummaryPK)other;
		return 
